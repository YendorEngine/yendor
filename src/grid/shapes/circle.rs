...
impl Circle {
    pub fn new<R: Into<u32>>(center: ChunkPosition, radius: R) -> Self {
        Self {
            center,
            radius: radius.into(),
        }
...
impl Circle {
    #[inline]
    pub const fn center(&self) -> ChunkPosition { self.center }

    #[inline]
    pub fn left(&self) -> ChunkPosition { self.center - IVec2::new(self.radius as i32, 0) }

    #[inline]
    pub fn right(&self) -> ChunkPosition { self.center + IVec2::new(self.radius as i32, 0) }

    #[inline]
    pub fn top(&self) -> ChunkPosition { self.center + IVec2::new(0, self.radius as i32) }

    #[inline]
    pub fn bottom(&self) -> ChunkPosition { self.center + IVec2::new(0, self.radius as i32) }
...
impl ShapeIter for Circle {
    type Iterator = bevy::utils::hashbrown::hash_set::IntoIter<ChunkPosition>;
...
impl IntoIterator for Circle {
    type IntoIter = bevy::utils::hashbrown::hash_set::IntoIter<ChunkPosition>;

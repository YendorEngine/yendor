...
impl Circle {
    ...
    #[inline]
    pub fn left(&self) -> IVec2 { self.center - IVec2::new(self.radius as i32, 0) }

    #[inline]
    pub fn right(&self) -> IVec2 { self.center + IVec2::new(self.radius as i32, 0) }

    #[inline]
    pub fn top(&self) -> IVec2 { self.center + IVec2::new(0, self.radius as i32) }

    #[inline]
    pub fn bottom(&self) -> IVec2 { self.center + IVec2::new(0, self.radius as i32) }

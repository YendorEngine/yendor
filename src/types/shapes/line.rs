...
impl<const GRID_WIDTH: u32, const GRID_HEIGHT: u32> Line<GRID_WIDTH, GRID_HEIGHT> {
    #[inline(always)]
    pub const fn new(start: Position<GRID_WIDTH, GRID_HEIGHT>, end: Position<GRID_WIDTH, GRID_HEIGHT>) -> Self { Self { start, end } }

    #[allow(dead_code)]
    #[inline]
    fn iter_exlusive(&self) -> BresenhamLineIter<GRID_WIDTH, GRID_HEIGHT> { BresenhamLineIter::new(self.start, self.end) }
}

impl<const GRID_WIDTH: u32, const GRID_HEIGHT: u32> Shape<GRID_WIDTH, GRID_HEIGHT> for Line<GRID_WIDTH, GRID_HEIGHT> {
    #[inline]
...
impl<const GRID_WIDTH: u32, const GRID_HEIGHT: u32> ShapeIter<GRID_WIDTH, GRID_HEIGHT> for Line<GRID_WIDTH, GRID_HEIGHT> {
...
impl<const GRID_WIDTH: u32, const GRID_HEIGHT: u32> From<Line<GRID_WIDTH, GRID_HEIGHT>> for BoxedShape<GRID_WIDTH, GRID_HEIGHT> {

...
impl<const GRID_WIDTH: u32, const GRID_HEIGHT: u32> Circle<GRID_WIDTH, GRID_HEIGHT> {
    ...
    #[inline]
    pub fn left(&self) -> Position<GRID_WIDTH, GRID_HEIGHT> { self.center - IVec2::new(self.radius as i32, 0) }

    #[inline]
    pub fn right(&self) -> Position<GRID_WIDTH, GRID_HEIGHT> { self.center + IVec2::new(self.radius as i32, 0) }

    #[inline]
    pub fn top(&self) -> Position<GRID_WIDTH, GRID_HEIGHT> { self.center + IVec2::new(0, self.radius as i32) }

    #[inline]
    pub fn bottom(&self) -> Position<GRID_WIDTH, GRID_HEIGHT> { self.center + IVec2::new(0, self.radius as i32) }
...
impl<const GRID_WIDTH: u32, const GRID_HEIGHT: u32> Shape<GRID_WIDTH, GRID_HEIGHT> for Circle<GRID_WIDTH, GRID_HEIGHT> {
    #[inline]
    // FIX: PERF??
    fn get_count(&self) -> u32 { self.get_positions().len() as u32 }

    #[inline]
    fn contains(&self, position: Position<GRID_WIDTH, GRID_HEIGHT>) -> bool { self.get_positions().contains(&position) }
...
impl<const GRID_WIDTH: u32, const GRID_HEIGHT: u32> ShapeIter<GRID_WIDTH, GRID_HEIGHT> for Circle<GRID_WIDTH, GRID_HEIGHT> {
...
impl<const GRID_WIDTH: u32, const GRID_HEIGHT: u32> From<Circle<GRID_WIDTH, GRID_HEIGHT>> for BoxedShape<GRID_WIDTH, GRID_HEIGHT> {
